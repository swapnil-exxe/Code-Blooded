...
# -----------------------------------------------------------------------------
# FILE 1: 01_PROBLEM_AND_SOLUTION.md
# -----------------------------------------------------------------------------
doc1_content = r"""## Executive Overview & Real-World Context
...
write_doc("01_PROBLEM_AND_SOLUTION.md", "01. Problem Statement & Solution Overview", doc1_content)

# -----------------------------------------------------------------------------
# FILE 2: 02_SYSTEM_ARCHITECTURE.md
# -----------------------------------------------------------------------------
doc2_content = r"""## Complete Layered Architecture
...
write_doc("02_SYSTEM_ARCHITECTURE.md", "02. Complete System Architecture", doc2_content)

# -----------------------------------------------------------------------------
# FILE 3: 03_DATA_AND_DATASET.md
# -----------------------------------------------------------------------------
doc3_content = r"""## Data Lineage & Lifecycle
...
write_doc("03_DATA_AND_DATASET.md", "03. Data Pipeline & Dataset Lineage", doc3_content)

# -----------------------------------------------------------------------------
# FILE 4: 04_SCRAPER_DEEP_DIVE.md
# -----------------------------------------------------------------------------
doc4_content = r"""## Live Scraper Engine Architecture (`scraper/`)
...
write_doc("04_SCRAPER_DEEP_DIVE.md", "04. Live Scraper Engine Deep Dive", doc4_content)

# -----------------------------------------------------------------------------
# FILE 5: 05_DATABASE_DEEP_DIVE.md
# -----------------------------------------------------------------------------
doc5_content = r"""## Dual-Database & Analytical Parquet Architecture
...
write_doc("05_DATABASE_DEEP_DIVE.md", "05. Database Architecture & ER Deep Dive", doc5_content)

# -----------------------------------------------------------------------------
# FILE 6: 06_ML_MODELS_DEEP_DIVE.md
# -----------------------------------------------------------------------------
doc6_content = r"""## The 4 Independent Analytical Core Models
...
write_doc("06_ML_MODELS_DEEP_DIVE.md", "06. Analytical & Machine Learning Core Models", doc6_content)

# -----------------------------------------------------------------------------
# FILE 7: 07_FEATURE_ENGINEERING.md
# -----------------------------------------------------------------------------
doc7_content = r"""## Feature Engineering Pipeline (`feature_engineering/`)
...
write_doc("07_FEATURE_ENGINEERING.md", "07. Feature Engineering Registry", doc7_content)

# -----------------------------------------------------------------------------
# FILE 8: 08_RULE_ENGINE.md
# -----------------------------------------------------------------------------
doc8_content = r"""## Statutory Delay SLA Rule Engine (`rule_engines/delay/`)
...
write_doc("08_RULE_ENGINE.md", "08. Statutory SLA Rule Engine", doc8_content)

# -----------------------------------------------------------------------------
# FILE 9: 09_BACKEND_FASTAPI.md
# -----------------------------------------------------------------------------
doc9_content = r"""## FastAPI Application Gateway Architecture (`api/`)
...
write_doc("09_BACKEND_FASTAPI.md", "09. FastAPI Backend Application Gateway", doc9_content)

# -----------------------------------------------------------------------------
# FILE 10: 10_AUTH_RBAC_SECURITY.md
# -----------------------------------------------------------------------------
doc10_content = r"""## Authentication, RBAC & Security Architecture
...
write_doc("10_AUTH_RBAC_SECURITY.md", "10. Authentication, RBAC & Security Architecture", doc10_content)

# -----------------------------------------------------------------------------
# FILE 11: 11_FRONTEND_UI_UX.md
# -----------------------------------------------------------------------------
doc11_content = r"""## React 18 Single-Page Application (`frontend/`)
...
write_doc("11_FRONTEND_UI_UX.md", "11. Frontend Command-Center UI/UX", doc11_content)

# -----------------------------------------------------------------------------
# FILE 12: 12_AI_CHATBOT.md
# -----------------------------------------------------------------------------
doc12_content = r"""## Subho AI Governance Chatbot (`api/routers/chat.py`)
...
write_doc("12_AI_CHATBOT.md", "12. Subho AI Governance Chatbot", doc12_content)

# -----------------------------------------------------------------------------
# FILE 13: 13_TESTING_QA.md
# -----------------------------------------------------------------------------
doc13_content = r"""## Automated Test Suite Architecture (`tests/`)
...
write_doc("13_TESTING_QA.md", "13. Comprehensive Automated Test Suite & QA", doc13_content)

# -----------------------------------------------------------------------------
# FILE 14: 14_PERFORMANCE_DEPLOYMENT.md
# -----------------------------------------------------------------------------
doc14_content = r"""## Performance Optimization & Deployment Architecture
...
write_doc("14_PERFORMANCE_DEPLOYMENT.md", "14. Performance Optimization & Deployment Guide", doc14_content)

# -----------------------------------------------------------------------------
# FILE 15: 15_FILE_STRUCTURE.md
# -----------------------------------------------------------------------------
doc15_content = r"""## Complete Workspace Directory & File Map
...
write_doc("15_FILE_STRUCTURE.md", "15. Complete Repository File Map", doc15_content)

# -----------------------------------------------------------------------------
# FILE 16: 16_DIAGRAMS.md
# -----------------------------------------------------------------------------
doc16_content = r"""## System Architecture & Data Flow Mermaid Diagrams
...
write_doc("16_DIAGRAMS.md", "16. Master Mermaid Architecture Diagrams", doc16_content)

# -----------------------------------------------------------------------------
# FILE 17: 17_VIVA_QUESTIONS_ANSWERS.md
# -----------------------------------------------------------------------------
doc17_content = r"""## Technical Viva Questions & Detailed Answers
...
write_doc("17_VIVA_QUESTIONS_ANSWERS.md", "17. Viva Questions & Expert Answers", doc17_content)

# -----------------------------------------------------------------------------
# FILE 18: 18_WHY_THIS_TECHNOLOGY.md
# -----------------------------------------------------------------------------
doc18_content = r"""## Technology Selection Justification Matrix
...
write_doc("18_WHY_THIS_TECHNOLOGY.md", "18. Technology Selection Justifications", doc18_content)

# -----------------------------------------------------------------------------
# FILE 19: 19_HACKATHON_JUDGE_QA.md
# -----------------------------------------------------------------------------
doc19_content = r"""## Evaluator & Hackathon Judge Q&A
...
write_doc("19_HACKATHON_JUDGE_QA.md", "19. Hackathon & Evaluator Q&A", doc19_content)

# -----------------------------------------------------------------------------
# FILE 20: 20_FINAL_CHEAT_SHEET.md
# -----------------------------------------------------------------------------
...
write_doc("20_FINAL_CHEAT_SHEET.md", "20. Final One-Page Reference Cheat Sheet", doc20_content)

print("\nAll 20 modular knowledge base files successfully generated in docs/knowledge_base/")
