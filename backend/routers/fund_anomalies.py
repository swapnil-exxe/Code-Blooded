...
from api.auth import OptionalUser, apply_work_joined_scope, verify_work_jurisdiction
...
def list_fund_anomalies(
    ...
    query, _ = apply_work_joined_scope(query, current_user, FundExpenditureResult, already_joined=already_joined)
